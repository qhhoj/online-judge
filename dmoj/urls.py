...
from judge.views.select2 import (
    ...
    MirrorProblemSelect2View,
    OrganizationSelect2View,
    OrganizationUserSelect2View,
    ProblemSelect2View,
    TagGroupSelect2View,
    TagSelect2View,
...
register_patterns = [
    ...
    path(
        'register/complete/',
        TitledTemplateView.as_view(
            template_name=REGISTRATION_COMPLETE_TEMPLATE,
...
urlpatterns = [
    ...
    path(
        'admin/user-activity/', include([
            ...
            path(
                'api/authenticated-sessions/', user_activity.authenticated_sessions_api,
                name='authenticated_sessions_api',
            ),
    ...
    path(
        'problem/<str:problem>', include([
            ...
            path(
                '/manage/submission', include([
                    path('', problem_manage.ManageProblemSubmissionView.as_view(), name='problem_manage_submissions'),
                    path('/rejudge', problem_manage.RejudgeSubmissionsView.as_view(), name='problem_submissions_rejudge'),  # noqa: E501
                    path(
                        '/rejudge/preview', problem_manage.PreviewRejudgeSubmissionsView.as_view(),
                        name='problem_submissions_rejudge_preview',
                    ),
                    path(
                        '/rejudge/success/<slug:task_id>', problem_manage.rejudge_success,
                        name='problem_submissions_rejudge_success',
                    ),
                    path(
                        '/rescore/all', problem_manage.RescoreAllSubmissionsView.as_view(),
                        name='problem_submissions_rescore_all',
                    ),
                    path(
                        '/rescore/success/<slug:task_id>', problem_manage.rescore_success,
    ...
    path(
        'src/<int:submission>/download', submission.SubmissionSourceDownload.as_view(),
        name='submission_source_download',
    ),

    path(
        'submission/<int:submission>', include([
    ...
    path(
        'contest/<str:contest>', include([
            ...
            path('/judge', contests.ContestJudgeView.as_view(), name='contest_judge'),
            ...
            path(
                '/submissions/<str:user>/<str:problem>/',
            ...
            path(
                '/participations/<str:user>',
                contests.ContestParticipationList.as_view(), name='contest_participation',
            ),
            path(
                '/participation/disqualify', contests.ContestParticipationDisqualify.as_view(),
    ...
    path(
        'organization/<slug:slug>', include([
            ...
            path('/problem-create', organization.ProblemCreateOrganization.as_view(), name='problem_create_organization'),  # noqa: E501
            path(
                '/import-polygon', organization.ProblemImportPolygonOrganization.as_view(),
                name='problem_import_polygon_organization',
            ),
            path('/contest-create', organization.ContestCreateOrganization.as_view(), name='contest_create_organization'),  # noqa: E501

            path('/request', organization.RequestJoinOrganization.as_view(), name='request_organization'),
            path(
                '/request/<int:rpk>', organization.OrganizationRequestDetail.as_view(),
                name='request_organization_detail',
            ),
            path(
                '/requests/', include([
                    path('pending', organization.OrganizationRequestView.as_view(), name='organization_requests_pending'),  # noqa: E501
                    path('log', organization.OrganizationRequestLog.as_view(), name='organization_requests_log'),
                    path(
                        'approved', organization.OrganizationRequestLog.as_view(states=('A',), tab='approved'),
                        name='organization_requests_approved',
                    ),
                    path(
                        'rejected', organization.OrganizationRequestLog.as_view(states=('R',), tab='rejected'),
            ...
            path(
                '/post/', include([
                    path('new', organization.BlogPostCreateOrganization.as_view(), name='blog_post_create_organization'),  # noqa: E501
                ]),
            ),
        ...
        'widgets/', include([
            ...
            path(
                'select2/', include([
                    ...
                    path(
                        'contest_users/<str:contest>', ContestUserSearchSelect2View.as_view(),
            ...
            path(
                'preview/', include([
                    ...
                    path('organization', preview.OrganizationMarkdownPreviewView.as_view(), name='organization_preview'),  # noqa: E501
    ...
    path(
        'judge-select2/', include([
            path('profile/', UserSelect2View.as_view(), name='profile_select2'),
            path(
                'organization_profile/<int:pk>/', OrganizationUserSelect2View.as_view(),
