...
mathml_attrs = {
    'mo': [
        'accent', 'dir', 'fence', 'form', 'indentalign', 'indentalignfirst', 'indentalignlast', 'indentshift',
    ...
    'mtable': [
        'align', 'alignmentscope', 'columnalign', 'columnlines', 'columnspacing', 'columnwidth', 'displaystyle',
    ...
    'math': [
        'altimg', 'altimg-width', 'altimg-height', 'altimg-valign', 'alttext', 'dir', 'display', 'overflow',
    ...
    'mtd': [
        'columnalign', 'columnspan', 'groupalign', 'rowalign', 'rowspan', 'href', 'id', 'mathbackground',
        'mathcolor',
    ],
    ...
    'mstyle': [
        'decimalpoint', 'displaystyle', 'infixlinebreakstyle', 'scriptlevel', 'scriptminsize',
    ...
    'mspace': [
        'height', 'indentalign', 'indentalignfirst', 'indentalignlast', 'indentshift', 'indentshiftfirst',
