        ...
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[
                    (
                        'A',
                        'Show all testcase result',
                    ),
                    (
                        'B',
                        'Show batch result only',
                    ),
                    (
                        'S',
                        'Show submission result only',
                    ),
                ],
                default='A',
                help_text='What testcase result should be showed to users?',
                max_length=1,
                verbose_name='Testcase result visibility',
            ),
        ),
        migrations.RunPython(
            update_testcase_result_visibility_mode,
            reverse_update_testcase_result_visibility_mode,
        ),
