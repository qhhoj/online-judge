...
class Language(models.Model):
    ...
    common_name = models.CharField(
        max_length=20, verbose_name=_('common name'),
        help_text=_(
    ...
    ace = models.CharField(
        max_length=20, verbose_name=_('ace mode name'),
        help_text=_(
    ...
    pygments = models.CharField(
        max_length=20, verbose_name=_('pygments name'),
    ...
    info = models.CharField(
        max_length=50, verbose_name=_('runtime info override'), blank=True,
        help_text=_(
...
class Judge(models.Model):
    name = models.CharField(
        max_length=50, verbose_name=_('judge name'), help_text=_('Server name, hostname-style.'),
        unique=True,
    )
    created = models.DateTimeField(auto_now_add=True, verbose_name=_('time of creation'))
    auth_key = models.CharField(
        max_length=100, help_text=_('A key to authenticate this judge.'),
        verbose_name=_('authentication key'),
    )
    is_blocked = models.BooleanField(
        verbose_name=_('block judge'), default=False,
        help_text=_(
    ...
    is_disabled = models.BooleanField(
        verbose_name=_('disable judge'), default=False,
    ...
    load = models.FloatField(
        verbose_name=_('system load'), null=True,
