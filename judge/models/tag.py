...
class TagProblem(models.Model):
    code = models.CharField(
        max_length=32, verbose_name=_('problem code'), unique=True, db_index=True,
        validators=[RegexValidator('^[a-zA-Z0-9_]+$', _('Problem code must be ^[a-zA-Z0-9_]+$'))],
        help_text=_(
            'A short, unique code for the problem, '
    ...
    link = models.URLField(
        max_length=200, verbose_name=_('Problem URL'),
        help_text=_('Full URL to the problem.'),
    )
    judge = models.CharField(
        max_length=30, verbose_name=_('Online Judge'), blank=True, null=True, db_index=True,
