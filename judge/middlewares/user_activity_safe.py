...
class UserActivityMiddleware:
    ...
    def __init__(self, get_response):
        ...
        try:
            ...
            logger.exception('Cannot import UserActivity models')
            self.enabled = False
        except Exception:
            logger.exception('Error initializing UserActivity middleware')
            self.enabled = False
    ...
    def __call__(self, request):
        ...
        try:
            ...
            logger.exception('Critical error in UserActivity middleware')
    ...
    def _safe_log_activity(self, request, response):
        ...
        try:
            ...
            logger.exception('Error in _safe_log_activity')
